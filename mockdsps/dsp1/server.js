      ...
      bid: [
        {
          ...
          price: 1.00,
          adid: "test_campaign",
          burl: "http://localhost:8000/win/bill?auction_id=${AUCTION_ID}&bid_id=${AUCTION_BID_ID}&imp_id=${AUCTION_IMP_ID}&seat_id=${AUCTION_SEAT_ID}&ad_id=${AUCTION_AD_ID}&price=${AUCTION_PRICE}&currency=${AUCTION_CURRENCY}",
          nurl: "http://localhost:8000/win/notice?ap=${AUCTION_PRICE}&t=8m0OJBZ7871n3RGbrC6jz8mmgocK3okt1DBd_36kZURw8Vf56tf2wDF-Nd7e4i1XnxggaauMDjNEst1xmIrGW-JitQ",
          ...
          iurl: "http://localhost:8000/win/inform?auction_price=${AUCTION_PRICE}",
          cid: "test_campaign",
          crid: "test_creative",
          attr: [
            4
...
server.listen(8000, () => {
  console.log("Server 1 listening at %s", server.name, server.url)
})

let bidResponse = {
  id: "92d64adssd21e44asdfa5bef",
  seatbid: [
    {
      seat: 'test seat',
      bid: [
        {
          id: "sdffffffffffffffffffffadsdf",
          impid: "e60f4faf-9eab-4fcf-bb07-4619197a38ff",
          price: parseFloat((1 + Math.random() * 0.5).toFixed(2)),
          adid: "test_campaign",
          burl: "http://localhost:8001/win/bill?auction_id=${AUCTION_ID}&bid_id=${AUCTION_BID_ID}&imp_id=${AUCTION_IMP_ID}&seat_id=${AUCTION_SEAT_ID}&ad_id=${AUCTION_AD_ID}&price=${AUCTION_PRICE}&currency=${AUCTION_CURRENCY}",
          nurl: "http://localhost:8001/win/notice?ap=${AUCTION_PRICE}&t=8m0OJBZ7871n3RGbrC6jz8mmgocK3okt1DBd_36kZURw8Vf56tf2wDF-Nd7e4i1XnxggaauMDjNEst1xmIrGW-JitQ",
          ...
          iurl: "http://localhost:8001/win/inform?auction_price=${AUCTION_PRICE}",
          cid: "test_campaign",
          crid: "test_creative",
          attr: [
            4
...
server.listen(8001, () => {
  console.log("Server 2 listening at %s", server.name, server.url)
})
